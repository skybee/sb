...
class video_replace_lib{
    ...
    private function get_video_pattern(){
        $paterns['youtube']['pattern']  = "#<iframe[\s\S]+?['\"][\s\S]+?youtube.com/embed/(\w+)\??[\s\S]*?['\"][\s\S]+?</iframe>#i";
        $paterns['youtube']['replace']  = "<iframe width=\"616\" height=\"360\" src=\"//www.youtube.com/embed/$1\" frameborder=\"0\" allowfullscreen></iframe>";
        
        $paterns['vimeo']['pattern']    = "#<iframe[\s\S]+?['\"][\s\S]+?player.vimeo.com/video/(\d+)\??[\s\S]*?['\"][\s\S]+?</iframe>#i";
        $paterns['vimeo']['replace']    = "<iframe src=\"//player.vimeo.com/video/$1\" width=\"616\" height=\"360\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";
