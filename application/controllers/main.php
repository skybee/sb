...
//        echo '<pre>'.print_r($data_ar,1).'</pre>';
        ...
        $top_slider['articles']         = $this->article_m->get_top_slider_data($data_ar['main_cat_ar']['id'], 8, 90, 0, 350); // 1.5 sec.
...
//        echo '<pre>'.print_r($top_slider,1).'</pre>';
    ...
    function document($cat_name, $s_cat_name, $url_id_name) {
        ...
        $data_ar['second_menu_list']    = $this->list_m->get_cat($data_ar['main_cat_ar']['id']);
        $data_ar['footer_menu_list']    = $this->list_m->get_footer_cat_link();
        $data_ar['meta']['title']       = $data_ar['s_cat_ar']['name'].': '.$data_ar['doc_data']['title'].' - Odnako.su';
...
//        echo '<pre>'.print_r($data_ar['like_articles'],1).'</pre>';
        ...
        $top_slider['articles']         = $this->article_m->get_top_slider_data( $data_ar['s_cat_ar']['id'], 8, 90, 0, 350);
